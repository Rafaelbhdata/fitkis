...
const STATUS_CFG: Record<AppointmentStatus, { bg: string; border: string; timeColor: string }> = {
  ...
  confirmed:    { bg: 'rgba(178,255,153,0.18)', border: 'rgba(74,124,58,0.55)',  timeColor: 'rgba(74,124,58,0.9)'    },
  completed:    { bg: 'rgba(40,40,40,0.12)',     border: 'rgba(40,40,40,0.6)',    timeColor: 'rgba(40,40,40,0.75)'    },
